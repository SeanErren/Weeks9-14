...
public class SwapPainters : MonoBehaviour
{
    ...
    public Transform mainPainterPos;
    ...
    {
        //Only if the pointer is above the painters
        if (mainPainterPos.transform.position.x == pointerScript.pointerPositions[pointerScript.currentPos])
        {
